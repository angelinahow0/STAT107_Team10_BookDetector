...
## Team Contributions for Final Deliverable: [EDIT THIS] 
Angelina How:
...
- Edited the code to remove the stopwords in the data
...
- Added all the required packages to the 00_requirments.R and described them
...
- Wrote the code to remove stopwords in the data
